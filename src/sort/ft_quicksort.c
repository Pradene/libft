...
static ptrdiff_t
ft_quicksort_partition(char *base, ptrdiff_t low, ptrdiff_t high, size_t size,
...
static void ft_quicksort_recurse(char *base, ptrdiff_t low, ptrdiff_t high,
                                 size_t size,
                                 int (*comp)(const void *, const void *)) {
  if (low < high) {
...
void ft_quicksort(void *base, size_t nb, size_t size,
                  int (*comp)(const void *, const void *)) {
  if (nb <= 1 || size == 0) {
    return;
  }
